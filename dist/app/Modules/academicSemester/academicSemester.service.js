...
const createSemester = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    if (academicSemester_constant_1.AcademicSemesterTitleCodeMapper[payload.title] !== payload.code) {
        throw new ApiErrors_1.default(400, 'Title and Code not matched');
    }
...
const getAllSemester = (filters, paginationOptions) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (searchTerm) {
        andConditions.push({
            $or: academicSemester_constant_1.searchFileds.map(fild => ({
                [fild]: {
                    $regex: searchTerm,
                    $options: 'i',
                },
    ...
    const { page, limit, skip, sortBy, sortOrder } = paginationHelper_1.paginationHelpers.calclutePagination(paginationOptions);
...
const getSingelSemester = (id) => __awaiter(void 0, void 0, void 0, function* () {
...
const updateSemester = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    if (payload.title &&
        ...
        throw new ApiErrors_1.default(http_status_codes_1.StatusCodes.BAD_REQUEST, 'Title and Code not matched');
    }
